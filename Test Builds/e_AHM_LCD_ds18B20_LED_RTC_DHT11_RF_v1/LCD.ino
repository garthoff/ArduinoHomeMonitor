void updateLCD(){
	...
	lcd.setCursor(0, 1);
	lcd.print("Box:"); lcd.print(temp1,1);  lcd.print("C  ");
	lcd.print("Amb:");  lcd.print(temp2,1);  lcd.print("C");
	lcd.setCursor(0, 2);
              #ifdef DHT11_module
                lcd.print("Hum:");     lcd.print((float)DHT11.humidity, 0);    lcd.print("% ");
                lcd.print("T:");       lcd.print((float)DHT11.temperature, 1);    lcd.print("C");
                lcd.print(" ");
